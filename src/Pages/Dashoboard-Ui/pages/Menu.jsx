                    ...
                    <ul className="navbar-nav" id="navbar-nav">
                              ...
                              <div className="collapse" id="sidebarProducts">
                                   <ul className="nav sub-navbar-nav">
                                        <li className="sub-nav-item">
                                             <Link className="sub-nav-link" to={"/addproduct"}>Create</Link>
                                        </li>
                                          <li className="sub-nav-item">
                                             <Link className="sub-nav-link" to={"/productlist"}>Product List</Link>
                                        </li>
                                   </ul>
                              </div>
                         </li>
                         ...
                         <li className="nav-item">
                              ...
                              <div className="collapse" id="sidebarCategory">
                                   <ul className="nav sub-navbar-nav">
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="category-list.html">List</a>
                                        </li>                         
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="category-edit.html">Edit</a>
                                        </li>
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="category-add.html">Create</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
                         ...
                         <li className="nav-item">
                              <a className="nav-link menu-arrow" href="#sidebarInventory" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarInventory">
                                   <span className="nav-icon">
                              ...
                              <div className="collapse" id="sidebarInventory">
                                   <ul className="nav sub-navbar-nav">
                                        ...
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="inventory-warehouse.html">Warehouse</a>
                                        </li>
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="inventory-received-orders.html">Received Orders</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
                         ...
                         <li className="nav-item">
                              ...
                              <div className="collapse" id="sidebarOrders">
                                   <ul className="nav sub-navbar-nav">
                                        ...
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="orders-list.html">List</a>
                                        </li>
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="order-detail.html">Details</a>
                                        </li>
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="order-cart.html">Cart</a>
                                        </li>
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="order-checkout.html">Check Out</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
                         ...
                         <li className="nav-item">
                              <a className="nav-link menu-arrow" href="#sidebarPurchases" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPurchases">
                                   <span className="nav-icon">
                              ...
                              <div className="collapse" id="sidebarPurchases">
                                   <ul className="nav sub-navbar-nav">
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="purchase-list.html">List</a>
                                        </li>
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="purchase-order.html">Order</a>
                                        </li>
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="purchase-returns.html">Return</a>
                                        </li>
                                   </ul>
                              </div>
                         </li>
                         ...
                         <li className="nav-item">
                              <a className="nav-link menu-arrow" href="#sidebarCustomers" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCustomers">
                                   <span className="nav-icon">
                              ...
                              <div className="collapse" id="sidebarCustomers">
                                   <ul className="nav sub-navbar-nav">
                                        ...
                                        <li className="sub-nav-item">
                                             <a className="sub-nav-link" href="customer-list.html">List</a>
                                        </li>
                                        <li className="sub-nav-item">
